...
class nozzle:
    ...
    def __init__(self, model, section, NPR=None, ref_rttot=1.0, scale_ps=1.0):
        ...
        self.nozzle = nz.nozzle(
            x=None, section=section, gamma=self._gam
        )  # for future version: , ref_rttot=ref_rttot, scale_ps=1.)
    ...
    def set_NPR(self, NPR):
        ...
        if NPR < self.NPR0:  # flow is fully subsonic
            ...
            _Minit = 0.0 * self.section + 0.5
            _Minit[self.ithroat :] = 2.0
